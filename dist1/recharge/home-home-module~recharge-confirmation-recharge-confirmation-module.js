(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module~recharge-confirmation-recharge-confirmation-module"],{
...
/***/ "./src/app/utils/formatter/index.ts":
/*!******************************************!*\
  !*** ./src/app/utils/formatter/index.ts ***!
  \******************************************/
...
var format = {
    msisdn: function (msisdn) {
        if (msisdn[0] === '0') {
            return _config__WEBPACK_IMPORTED_MODULE_0__["config"].COUNTRY_CODE + msisdn.trim().slice(1);
        }
        else if (msisdn[0] === '2' && msisdn[1] === '7') {
            return _config__WEBPACK_IMPORTED_MODULE_0__["config"].COUNTRY_CODE + msisdn.trim().slice(2);
        }
        else {
            return _config__WEBPACK_IMPORTED_MODULE_0__["config"].COUNTRY_CODE + msisdn;
        }
    }
};
...
//# sourceMappingURL=home-home-module~recharge-confirmation-recharge-confirmation-module.js.map